...
E tem também este [outro demo](https://gabrieldarezzo.github.io/busca_cep/){:target="_blank"}, que está mais elegante e funcional (tem até máscara!), criado pelo [**Gabriel Darezzo**](https://github.com/gabrieldarezzo){:target="_blank"} (valeu!!).
...
* A pesquisa do CEP é feita em um [web service](https://pt.wikipedia.org/wiki/Web_service){:target="_blank"} gratuito chamado [ViaCEP](https://viacep.com.br/ "Web service para consulta de endereço via CEP"){:target="_blank"}, desta forma você não precisa ter um banco de dados apenas para armazenar os CEP/endereços.
