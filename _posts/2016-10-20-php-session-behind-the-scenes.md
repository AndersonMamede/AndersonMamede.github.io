...
- If a **session id is found**, then PHP **retrieves the matching session file** ("sess_" + session id), and **unserialize and parses its content into the $_SESSION variable**;<br><br>
